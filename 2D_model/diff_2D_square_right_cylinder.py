...
def Calculator(t, threshold, length, width, x, y, d, scaling_vector):
    ...
    z_vals = np.hstack([np.fliplr(z_vals), z_vals])#duplication step to save time--> extends 1 quadrant calulation to all four using symmtery assumption. 
    return z_vals
